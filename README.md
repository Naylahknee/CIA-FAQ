...
For independent GitHub and Cloudflare hosting, follow [CLOUDFLARE_DEPLOYMENT.md](./CLOUDFLARE_DEPLOYMENT.md).

## Development

This is a full-stack [Vinext](https://github.com/cloudflare/vinext) application with Cloudflare D1 and R2 support.
